...
# Build a image
echo "Build images"
docker build -t order-services:v1 .

# Renamning the docker images to ghcr format
echo "Renaming the images"
docker tag shipping-service:v1 ghcr.io/mirfani340/devops-dicoding-3/order-services:v1
...
docker push ghcr.io/mirfani340/devops-dicoding-3/order-services:v1